...
local function update_pane(pos,name)
    if minetest.get_node(pos).name:find("xpanes:"..name) == nil then return end
    local sum = 0
    for i = 1, 4 do
...
register_panes("chain_fence_grey", {
    description = "Grey Chain Fence",
    tiles = {"xpanes_chain_fence_grey.png"},
    drawtype = "airlike",
    paramtype = "light",
    sunlight_propagates = true,
    walkable = false,
    ...
    buildable_to = true,
    air_equivalent = true,
    textures = {"xpanes_chain_fence_grey.png", "xpanes_chain_fence_grey.png", "xpanes_space.png"},
    inventory_image = "xpanes_chain_fence_grey.png",
    wield_image = "xpanes_chain_fence_grey.png",
    groups = {snappy = 3, pane = 1},
    sounds = default.node_sound_stone_defaults(),
    on_construct = function(pos)
	update_pane(pos, "chain_fence_grey")
    end,
    recipe = {
		{""                   , "default:steel_ingot", ""                   },
...
register_panes("chain_fence_red", {
    description = "Red Chain Fence",
    tiles = {"xpanes_chain_fence_red.png"},
    drawtype = "airlike",
    paramtype = "light",
    sunlight_propagates = true,
    walkable = false,
    ...
    buildable_to = true,
    air_equivalent = true,
    textures = {"xpanes_chain_fence_red.png", "xpanes_chain_fence_red.png", "xpanes_space.png"},
    inventory_image = "xpanes_chain_fence_red.png",
    wield_image = "xpanes_chain_fence_red.png",
    groups = {snappy = 3, pane = 1},
    sounds = default.node_sound_stone_defaults(),
    on_construct = function(pos)
	update_pane(pos, "chain_fence_red")
    end,
    recipe = {
		{""                   , "default:steel_ingot", ""                   },
...
register_panes("chain_fence_green", {
    description = "Green Chain Fence",
    tiles = {"xpanes_chain_fence_green.png"},
    drawtype = "airlike",
    paramtype = "light",
    sunlight_propagates = true,
    walkable = false,
    ...
    buildable_to = true,
    air_equivalent = true,
    textures = {"xpanes_chain_fence_green.png", "xpanes_chain_fence_green.png", "xpanes_space.png"},
    inventory_image = "xpanes_chain_fence_green.png",
    wield_image = "xpanes_chain_fence_green.png",
    groups = {snappy = 3, pane = 1},
    sounds = default.node_sound_stone_defaults(),
    on_construct = function(pos)
	update_pane(pos, "chain_fence_green")
    end,
    recipe = {
		{""                   , "default:steel_ingot", ""                   },
...
register_panes("chain_fence_blue", {
    description = "Blue Chain Fence",
    tiles = {"xpanes_chain_fence_blue.png"},
    drawtype = "airlike",
    paramtype = "light",
    sunlight_propagates = true,
    walkable = false,
    ...
    buildable_to = true,
    air_equivalent = true,
    textures = {"xpanes_chain_fence_blue.png", "xpanes_chain_fence_blue.png", "xpanes_space.png"},
    inventory_image = "xpanes_chain_fence_blue.png",
    wield_image = "xpanes_chain_fence_blue.png",
    groups = {snappy = 3, pane = 1},
    sounds = default.node_sound_stone_defaults(),
    on_construct = function(pos)
	update_pane(pos, "chain_fence_blue")
    end,
    recipe = {
		{""                   , "default:steel_ingot", ""                   },
