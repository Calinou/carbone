...
doors:register_door("doors:door_glass", {
	...
	tiles_bottom = {"door_glass_b.png", "door_grey_blue.png"},
	tiles_top = {"door_glass_a.png", "door_grey_blue.png"},
})

minetest.register_craft({
	output = "doors:door_glass 4",
	recipe = {
