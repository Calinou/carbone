...
local cart = {
	physical = true,
	collisionbox = {-0.5, -0.5, -0.5, 0.5, 0, 0.5},
	visual = "mesh",
	mesh = "cart.x",
	visual_size = {x = 1, y = 1},
	textures = {"cart.png"},
...
minetest.register_craftitem("carts:cart", {
	...
	wield_image = minetest.inventorycube("cart_top.png", "cart_side.png", "cart_side.png"),
...
minetest.register_node("carts:brake_rail", {
...
minetest.register_alias("carts:brakerail", "carts:brake_rail")
